...
class HospitalDisease(models.Model):
    ...
    parent_id = fields.Many2one(comodel_name='hospital.disease', index=True, ondelete='cascade')
    parent_path = fields.Char(index=True, unaccent=False)
    child_ids = fields.One2many(comodel_name='hospital.disease', inverse_name='parent_id')
